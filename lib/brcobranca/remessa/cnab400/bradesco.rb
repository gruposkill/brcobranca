    ...
    module Cnab400
      class Bradesco < Brcobranca::Remessa::Cnab400::Base
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << pagamento.numero.to_s.rjust(10, '0').split(//).last(10).join    # numero do documento          X[10]       111 a 120
          ...
          detalhe << (pagamento.cod_primeira_instrucao || '0').to_s.rjust(2, '0') # 1a instrucao                                9[02]       157 a 158
          detalhe << (pagamento.cod_segunda_instrucao || '0').to_s.rjust(2, '0')  # 2a instrucao                                9[02]       159 a 160
