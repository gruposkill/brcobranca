    ...
    module Cnab400
      class Itau < Brcobranca::Remessa::Cnab400::Base
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << (pagamento.cod_primeira_instrucao || '0').to_s.rjust(2, '0')    # 1a instrucao - deixar zero            X[02] 157-158
          detalhe << (pagamento.cod_segunda_instrucao || '0').to_s.rjust(2, '0')     # 2a instrucao - deixar zero            X[02] 159-160
          ...
          detalhe << ((!pagamento.data_mora.nil? && !pagamento.data_more.strftime.nil?) ? pagamento.data_mora.strftime('%d%m%y') : ''.rjust(6, '0')) # data da mora                          9[06] 386-391
