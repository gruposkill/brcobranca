    ...
    module Cnab400
      class Santander < Brcobranca::Remessa::Cnab400::Base
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << (pagamento.cod_primeira_instrucao || '0').to_s.rjust(2, '0')    # primeira instrução                    9[02]
          detalhe << (pagamento.cod_segunda_instrucao || '0').to_s.rjust(2, '0')     # segunda instrução                     9[02]
